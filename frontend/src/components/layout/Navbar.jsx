...
const Navbar = () => {
  ...
  return (
    <nav className="absolute lg:fixed top-4 md:top-8 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-7xl mx-auto transition-all duration-500">
      <div className="bg-[var(--bg-card)]/80 backdrop-blur-xl border border-[var(--border-card)] rounded-full px-4 py-2.5 md:px-8 md:py-3 shadow-2xl flex justify-between items-center relative group">
        ...
        <Link to="/" onClick={handleHomeClick} className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[var(--primary-green)] to-[var(--accent-blue)] p-2 shadow-lg shadow-emerald-500/20 flex items-center justify-center">
            <Apple className="text-white animate-pulse" size={20} />
          </div>
            ...
            <div className="flex items-center gap-4">
               {location.pathname !== '/onboarding' && (
                <Link
                  ...
                  className="flex items-center gap-2 bg-[var(--bg-card)] border border-[var(--border-card)] p-1.5 md:px-5 md:py-2.5 rounded-full md:rounded-2xl hover:border-[var(--primary-green)]/30 transition-all shadow-sm animate-in fade-in duration-300"
                >
                  ...
                  <span className="hidden md:inline text-xs font-bold text-[var(--text-main)] truncate max-w-[100px]">
